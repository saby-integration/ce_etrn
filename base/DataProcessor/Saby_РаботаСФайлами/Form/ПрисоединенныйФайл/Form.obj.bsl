...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекущийПользователь = Saby_ПользователиСлужебный.АвторизованныйПользователь();
...
Процедура СтандартныеУстановитьПометкуУдаления(Команда)
	...
	ТекстВопроса = Saby_ОбщегоНазначенияКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура Печать(Команда)
	...
	Если ЗначениеЗаполнено(ТекущаяСсылкаНаФайл()) Или ОбработатьКомандуЗаписиФайла() Тогда
		Файлы = Saby_ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ТекущаяСсылкаНаФайл());
...
Процедура Отправить(Команда)
	...
	Если ЗначениеЗаполнено(СсылкаНаТекущийОбъект)
		Или ОбработатьКомандуЗаписиФайла() Тогда
		Файлы = Saby_ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(СсылкаНаТекущийОбъект);
...
Процедура ОбновитьЗаголовок()
	...
	Если ЗначениеЗаполнено(СсылкаНаТекущийОбъект) Тогда
		Заголовок = Saby_ОбщегоНазначенияКлиентСервер.ПодставитьПараметрыВСтроку(
