...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.КомментарийКВерсии = Параметры.КомментарийКВерсии;
	ЭтаФорма.СоздатьНовуюВерсию = Параметры.СоздатьНовуюВерсию;
	Элементы.СоздатьНовуюВерсию.Доступность = Параметры.СоздатьНовуюВерсиюДоступность;
	
	Если Файл.ХранитьВерсии Тогда
		ЭтаФорма.СоздатьНовуюВерсию = Истина;
	Иначе
		ЭтаФорма.СоздатьНовуюВерсию = Ложь;
