...
Функция РезультатФункцииТитуловЭТрН(ИмяФункции, Параметр1 = Неопределено,
	...
	ИначеЕсли ИмяФункции = "ПредставлениеПоИмениПодстановки" Тогда
		Возврат ПредставлениеПоИмениПодстановкиЭТрН(Параметр1);
	...
	ИначеЕсли ИмяФункции = "ПустаяСсылка" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПустаяСсылка");
	Иначе
		Возврат Неопределено;
	КонецЕсли;
...
//
// Параметры:
//  ТипТитула - ПеречислениеСсылка.ESD_ТипТитулаЭтрН - титул, для которого необходимо получить титул отказа.
//
// Возвращаемое значение:
//   Структура - данные титула отказа:
//     * Тип - ПеречислениеСсылка.ESD_ТипТитулаЭтрН - титул, который был отменен.
...
Функция ТитулОтказаЭТрН(ТипТитула) Экспорт
	...
	РезультатФункции.Вставить("Тип",           ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПустаяСсылка"));
	РезультатФункции.Вставить("Представление", "");
	
	Если ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Погрузка") Тогда
		РезультатФункции.Тип           = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПолучениеГруза");
		РезультатФункции.Представление = "Получение" + Символы.ПС + "Не принят";
		Возврат РезультатФункции;
	ИначеЕсли ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости") Тогда
		РезультатФункции.Тип           = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.СогласованиеСтоимости");
...
Функция ЗначениеПоКодуЭТрН(Знач КодТитула) Экспорт
	...
	Если КодТитула = "1110339" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Погрузка");
	ИначеЕсли КодТитула = "1110340" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПолучениеГруза");
	ИначеЕсли КодТитула = "1110341" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПриемкаГруза");
	ИначеЕсли КодТитула = "1110342" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ВыдачаГруза");
		
	// Динамические титулы
	ИначеЕсли КодТитула = "1110343" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Переадресовка");
	ИначеЕсли КодТитула = "1167009" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПереадресовкаУведомление");
	ИначеЕсли КодТитула = "1110344" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС");
	ИначеЕсли КодТитула = "1110345" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости");
	ИначеЕсли КодТитула = "1110346" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.СогласованиеСтоимости");
		
	// Отрицательное завершение ДО
	ИначеЕсли КодТитула = "1115113" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.УведомлениеОУточнении");
	Иначе
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПустаяСсылка");
	КонецЕсли;
...
Функция ЗначениеПоИмениПодстановкиЭТрН(Знач ИмяПодстановки) Экспорт
	Код_ = КодИзИмениПодстановкиЭТрН(ИмяПодстановки);
	Возврат ЗначениеПоКодуЭТрН(Код_);
КонецФункции
...
Функция ЗначениеПоПредставлениюЭТрН(Представление) Экспорт
	...
	ИначеЕсли Представление = "Замена водителей/ТС" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС");
	ИначеЕсли Представление = "Изменение стоимости" Или Представление = "Изменить стоимость" Тогда
		Возврат ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости");
...
// Возвращает структуру различных представлений указанной ссылки по представлению титула, полученного из Saby.
//
// Параметры:
//  ИмяПодстановки - Строка - строковый код значения. Данный код чаще всего передает онлайн.
//
...
//
Функция ПредставлениеПоИмениПодстановкиЭТрН(Знач ИмяПодстановки) Экспорт
	Код_ = КодИзИмениПодстановкиЭТрН(ИмяПодстановки);
	Возврат ПредставлениеТитулаПоКодуЭТрН(Код_);
КонецФункции
...
//
// Параметры:
//  СсылкаНаТитул - ПеречислениеСсылка.ESD_ТипТитулаЭтрН - ссылка на титул,
...
Функция ПредставленияТитулаЭТрН(СсылкаНаТитул) Экспорт
	...
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПолучениеГруза") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("ПолучениеГруза", "1110340");
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПриемкаГруза") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("ПриемкаГруза", "1110341");
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ВыдачаГруза") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("ВыдачаГруза", "1110342");
		
	// Динамические титулы
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Переадресовка") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("Переадресовка", "1110343");
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПереадресовкаУведомление") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("ПереадресовкаУведомление", "1167009");
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("ЗаменаВодителяТС", "1110344");
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("ИзменениеСтоимости", "1110345");
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.СогласованиеСтоимости") Тогда
		Возврат СтруктураПредставленияТитулаЭТрН("СогласованиеСтоимости", "1110346");
		
	// Отрицательное завершение ДО
	ИначеЕсли СсылкаНаТитул = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.УведомлениеОУточнении") Тогда
...
// Возвращает структуру различных представлений указанной ссылки по коду титула.
//
// Параметры:
//  КодТитула - Строка - код титула.
//
// Возвращаемое значение:
//   Структура - структура различных представлений типа титула.
//     Перечень доступных значений см. в функции СтруктураПредставленияТитула
//
Функция ПредставлениеТитулаПоКодуЭТрН(Знач КодТитула) Экспорт
	Перем Результат;
	
	// Основные титулы
	Если КодТитула = "1110339" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("Погрузка", "1110339");
	ИначеЕсли КодТитула = "1110340" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("ПолучениеГруза", "1110340");
	ИначеЕсли КодТитула = "1110341" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("ПриемкаГруза", "1110341");
	ИначеЕсли КодТитула = "1110342" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("ВыдачаГруза", "1110342");
		
	// Динамические титулы
	ИначеЕсли КодТитула = "1110343" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("Переадресовка", "1110343");
	ИначеЕсли КодТитула = "1167009" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("ПереадресовкаУведомление", "1167009");
	ИначеЕсли КодТитула = "1110344" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("ЗаменаВодителяТС", "1110344");
	ИначеЕсли КодТитула = "1110345" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("ИзменениеСтоимости", "1110345");
	ИначеЕсли КодТитула = "1110346" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("СогласованиеСтоимости", "1110346");
		
	// Отрицательное завершение ДО
	ИначеЕсли КодТитула = "1115113" Тогда
		Результат = СтруктураПредставленияТитулаЭТрН("УведомлениеОУточнении", "1115113", "УведУточ_");
	Иначе
		Результат = СтруктураПредставленияТитулаЭТрН("ПустаяСсылка", "", "");
	КонецЕсли;
...
//
// Параметры:
//  ТипТитула - ПеречислениеСсылка.ESD_ТипТитулаЭтрН - титул для проверки
//
// Возвращаемое значение:
...
Функция ЭтоДинамическийТитулЭТрН(ТипТитула) Экспорт
	...
	Если ЗначениеЗаполнено(ТипТитула) Тогда
		...
		ТитулЗначение = ЗначениеПоПредставлениюЭТрН(ТипТитула);
		Если Не ЗначениеЗаполнено(ТитулЗначение) Тогда
			ТитулЗначение = ТипТитула;
		КонецЕсли;
		
		ДинамическиеТитулы = Новый Соответствие;
		ДинамическиеТитулы.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Переадресовка"),            Истина);
		ДинамическиеТитулы.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС"),         Истина);
		ДинамическиеТитулы.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости"),       Истина);
		ДинамическиеТитулы.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.СогласованиеСтоимости"),    Истина);
		ДинамическиеТитулы.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПереадресовкаУведомление"), Истина);
		ДинамическиеТитулы.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.УведомлениеОУточнении"),    Истина);

		РезультатФункции = ДинамическиеТитулы[ТитулЗначение] = Истина;
...
Функция ЭтоПервыйТитулЭТрН(ТипТитула) Экспорт
	...
	Возврат Не ЗначениеЗаполнено(ТипТитула) Или ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Погрузка");
...
//
// Возвращаемое значение:
//   ПеречислениеСсылка.ESD_ТипТитулаЭтрН - первый титул
//
...
Процедура СформироватьТаблицуДополненияЭТрН(МенеджерВременныхТаблиц, ТекущиеЭтапыДокумента, СсылкаНаДокумент) Экспорт
	...
	ЗапросДанных.УстановитьПараметр("Погрузка",       ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Погрузка"));
	ЗапросДанных.УстановитьПараметр("ПолучениеГруза", ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПолучениеГруза"));
	ЗапросДанных.УстановитьПараметр("ПриемкаГруза",   ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПриемкаГруза"));
	ЗапросДанных.УстановитьПараметр("ВыдачаГруза",    ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ВыдачаГруза"));
	ЗапросДанных.УстановитьПараметр("ПустаяСсылка",   ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПустаяСсылка"));
...
Функция СтруктураПредставленияТитулаЭТрН(ИмяТитула, КодТитула, ПрефиксПодстановки = "ЭТрН_")
	...
	ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН." + ИмяТитула);
	...
	ИначеЕсли ИмяТитула = "ИзменениеСтоимости" Тогда
		РезультатФункции.Представление = "Изменить стоимость";
	ИначеЕсли ИмяТитула = "СогласованиеСтоимости" Тогда
		РезультатФункции.Представление = "Согласовать стоимость";
...
Функция НазваниеСобытияОтрицательногоПереходаЭТрН(ТипТитула)
	...
	Если ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПриемкаГруза") Тогда
		РезультатФункции = "Приемка груза.Не принят";
	ИначеЕсли ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ВыдачаГруза") Тогда
...
Функция КодИзИмениПодстановкиЭТрН(Знач ИмяПодстановки)
	Код_ = СтрЗаменить(ИмяПодстановки, "ЭТрН_", "");
	Код_ = СтрЗаменить(Код_, "УведУточ_", "");
	Возврат Код_;
КонецФункции
