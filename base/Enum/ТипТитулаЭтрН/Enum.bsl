...
Функция ЭтоДинамическийТитулЭТрН(ТипТитула) Экспорт
	...
	Если ЗначениеЗаполнено(ТипТитула) Тогда 
		РезультатФункции = ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.Переадресовка")
			Или ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС")
			Или ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости")
			Или ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.СогласованиеСтоимости")
			Или ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ПереадресовкаУведомление")
			Или ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.УведомлениеОУточнении");
	КонецЕсли;
