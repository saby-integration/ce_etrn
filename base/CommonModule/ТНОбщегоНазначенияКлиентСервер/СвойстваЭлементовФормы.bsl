...
Процедура ГрупповаяУстановкаСвойствЭлементовФормы(Форма, СвойстваЭлементовФормы) Экспорт
	...
	Для Каждого МассивСвойств Из СвойстваЭлементовФормы Цикл
		...
		#Если Клиент Тогда
			МассивИмен = МодульКодаКлиент("Saby_ТНОбщегоНазначенияКлиентСервер").СтрРазделитьЭПД(МассивСвойств.Ключ, "_");
		#Иначе
			МассивИмен = МодульКода("Saby_ТНОбщегоНазначенияКлиентСервер").СтрРазделитьЭПД(МассивСвойств.Ключ, "_");
		#КонецЕсли
