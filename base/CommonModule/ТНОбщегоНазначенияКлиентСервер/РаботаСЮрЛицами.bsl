...
Процедура ДобавитьКонтактныеДанныеПоРоли(СтруктураДанныхЮрЛица, КонтактныеДанные,
	...
	// переход на во. промежуточный перевод в простые типы
	ИменаПеречисления = ВыполнитьНаСервере("Saby_ТНОбщегоНазначенияСервер.ВсеЗначенияПеречисления",
		"ТипыКонтактнойИнформации", Истина);
	...
	Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
		...
		ДозаполнитьКонтактныеДанные(ИменаПеречисления, СтруктураКонтактныхДанных);
