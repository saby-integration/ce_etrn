...
#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ИныеПолучатели
#КонецОбласти // include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ИныеПолучатели
...
#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ПрограммныйИнтерфейс
#КонецОбласти // include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ПрограммныйИнтерфейс
...
#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ОсновнойФункционал_ИменаСобытийЖурналаРегистрации
#КонецОбласти // include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ОсновнойФункционал_ИменаСобытийЖурналаРегистрации

#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ДополнительныйФункционал_СлужебныйПрограммныйИнтерфейс
#КонецОбласти // include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ДополнительныйФункционал_СлужебныйПрограммныйИнтерфейс

#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ОсновнойФункционал_ПараметрыОбменаAPI_СлужебныйПрограммныйИнтерфейс
#КонецОбласти // include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_ОсновнойФункционал_ПараметрыОбменаAPI_СлужебныйПрограммныйИнтерфейс
...
Функция ПараметрыВыгрузки(СсылкаНаДокумент) Экспорт
	...
	РезультатФункции.Вставить("ДополнительныеПараметры", Неопределено);
...
Функция РезультатВзаимодействияСоСБИС(Всего) Экспорт
	...
	РезультатФункции.Итог.Вставить("Успех",      Истина);
...
//
Функция ДокументооборотЗавершен(ИндексКартинки) Экспорт
	
	ДОЗавершенОтрицательно = ИндексКартинки_ДОЗавершенОтрицательно();
	ДОЗавершенПоложительно = ИндексКартинки_ДОЗавершенПоложительно();
	
	Возврат ИндексКартинки = ДОЗавершенОтрицательно Или ИндексКартинки = ДОЗавершенПоложительно;
...
#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_СообщениеПользователю
#КонецОбласти
...
#Область include_etrn_base_CommonModule_ТНОбщегоНазначенияКлиентСервер_КодыСостоянияДО
#КонецОбласти
