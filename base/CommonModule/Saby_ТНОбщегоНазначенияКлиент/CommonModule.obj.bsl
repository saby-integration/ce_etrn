...
Процедура ОбновитьДанныеЮрЛиц(Форма, СтруктураДанныхЮрЛиц, ПараметрыРеквизитаФормы)
	...
	Если ПараметрыРеквизитаФормы.ЭтоСтрокаТаблицы Тогда
		...
		КонецЕсли;
	Иначе
		Форма[ПараметрыРеквизитаФормы.ИмяРеквизита] = СтрокаЮрЛиц.НаименованиеОрганизации;
		Если Не ЗначениеЗаполнено(СтрокаЮрЛиц.НаименованиеОрганизации) Тогда
			Форма[ПараметрыРеквизитаФормы.ИмяРеквизита] = "Заполнить";
		КонецЕсли;
	КонецЕсли;
