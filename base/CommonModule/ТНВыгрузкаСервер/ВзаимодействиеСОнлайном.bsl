...
Функция ВложениеВыгружено(ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат)
	...
	Попытка
		...
		Иначе
			...
			ВыгрузитьЧерновик(ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат);
...
Процедура ЗаполнитьЯщикиУчастников(Вложение, ПараметрыМетода) Экспорт
	...
	Для Каждого Узел Из КлючиУзлов Цикл
		...
		Если ДанныеТитула.Свойство(ИмяУзла) Тогда
			...
			Если ЗначениеЗаполнено(ДанныеУзла.Идентификатор) Тогда
...
Процедура ВыгрузитьЧерновик(ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат)
