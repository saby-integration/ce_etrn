...
Функция ВыполнитьВыгрузку(ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат) Экспорт
...
Функция ЗаписаныСотрудники(ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат)
	...
	Для Каждого Сотрудник Из ПараметрыВыгрузки.СтруктураДокумента.ДанныеСотрудников Цикл
		...
		ЗаписатьСотрудника(Сотрудник, ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат);
...
Процедура ЗаписатьСотрудника(Сотрудник, ПараметрыВыгрузки, ОбщиеПараметрыВыгрузки, Результат)
	...
	Если ЭтоПервыйТитул Тогда
		...
		Исключение
			...
			ВыполнитьНаСервере("ESD_ТНОбщегоНазначенияСервер.ОбновитьДанныеСостояния", ПараметрыСтатус);
