...
Процедура ОбработкаВыбораТипаДанныхДокументаОснования(ВыбранныйЭлемент, ДопПараметры) Экспорт
	...
	Если ВыбранныйЭлемент <> Неопределено Тогда
		...
		Иначе
			...
			Оповещение = Новый ОписаниеОповещения(
				"ПослеВыбораЗначенияДокументаОснования", МодульКодаКлиент("ESD_ТНОбщегоНазначенияКлиент"), ДопПараметры);
...
&НаКлиенте
Функция ПутьКФайлуНастройки(ИмяФайлаПоУмолчанию = Неопределено, ПроверятьСуществованиеФайла = Ложь) Экспорт
	
	РезультатФункции = Неопределено;
	
	ДиалогВыбораФайла = Новый ДиалогВыбораФайла(РежимДиалогаВыбораФайла.Открытие);
	ДиалогВыбораФайла.Заголовок = "Выберите файл с настройками сопоставлений";
	ДиалогВыбораФайла.Фильтр = "Настройка сопоставления(*.txt)|*.txt";
	ДиалогВыбораФайла.ИндексФильтра = 0;
	ДиалогВыбораФайла.ПредварительныйПросмотр = Ложь;
	ДиалогВыбораФайла.ПроверятьСуществованиеФайла = ПроверятьСуществованиеФайла;
	ДиалогВыбораФайла.МножественныйВыбор = Ложь; 
	Если ИмяФайлаПоУмолчанию <> Неопределено Тогда
		ДиалогВыбораФайла.ПолноеИмяФайла = ИмяФайлаПоУмолчанию + ".txt";
	КонецЕсли;
...
Процедура ПослеВыбораПечатнойФормы(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ЗначениеЗаполнено(Результат.Id) Тогда
		ДополнительныеПараметры.Вставить("ПечатнаяФорма", Результат.Id);
	КонецЕсли;
...
#КонецОбласти // includr_etrn_base_CommonModule_ТНЗагрузкаСервер_ВзаимодействиеСОнлайном //&НаКлиенте

#Область includr_etrn_base_CommonModule_ТНЗагрузкаСервер_ИмяПродуктаЭПД
