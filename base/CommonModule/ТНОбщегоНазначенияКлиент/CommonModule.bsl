...
//  ТребуетсяОбновление - Булево - признак проведения загрузки данных из Saby
//  ТипДокумента - Строка - имя метаданных документа
//
&НаКлиенте
Процедура ОткрытьДокументВSABY(СсылкаНаДокумент, ТребуетсяОбновление = Ложь, ТипДокумента = Неопределено) Экспорт
