...
Процедура ЮрЛицоНажатие(Форма, РольСтрокой, ПараметрыРеквизитаФормы,
	...
	ПараметрыФормы.Вставить("ДокументОснование", Неопределено);
	ПараметрыРеквизитаФормы.Свойство("ДокументОснование", ПараметрыФормы.ДокументОснование);
	
	ПараметрыФормы.Вставить("ДоступныеВидыЛиц", "");
	ПараметрыРеквизитаФормы.Свойство("ДоступныеВидыЛиц", ПараметрыФормы.ДоступныеВидыЛиц);
	
	ДопПараметры = Новый Структура;
	ДопПараметры.Вставить("Форма",                         Форма);
	ДопПараметры.Вставить("ПроцедураПослеИзмененияЮрЛица", ПроцедураПослеИзмененияЮрЛица);
	
	Если ЗначениеЗаполнено(ПараметрыФормы.ДокументОснование) Тогда
