...
Процедура ЮрЛицоНажатие(Форма, РольСтрокой, ПараметрыРеквизитаФормы,
	...
	// Переход на простые типы для ВО 
	ДозаполнениеПараметровФормыОрганизацииЭПД(ПараметрыФормы);
...
Процедура ОткрытьФормуКонтактнойИнформации(ДополнительныеПараметры)
	...
	МодульКодаКлиент("УправлениеКонтактнойИнформациейКлиент").ОткрытьФормуКонтактнойИнформации(ПараметрыКИ, ЭтотОбъект, Оповещение);
