...
Функция ПараметрыВидаКонтактнойИнформации(Знач ТипКонтактнойИнформации) Экспорт
	...
	Если МодульУправлениеКонтактнойИнформацией <> Неопределено Тогда
		Возврат МодульУправлениеКонтактнойИнформацией.ПараметрыВидаКонтактнойИнформации(ТипКонтактнойИнформации);
	Иначе
...
Функция ПроверитьНаличиеПараметровПодключенияЭПД(Обработка = Неопределено) Экспорт
	...
	Если Не ЗначениеЗаполнено(СтруктураСессии) Тогда
		Возврат Неопределено;
	КонецЕсли;
