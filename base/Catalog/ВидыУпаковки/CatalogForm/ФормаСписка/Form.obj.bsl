...
Процедура ЗагрузитьПоНаименованию(Команда)
	...
	ПроцедураПослеВводаНаименования = Новый ОписаниеОповещения("ПослеВводаНаименования", ЭтотОбъект);
...
Функция РезультатЗагрузкиСправочника(Знач МассивНаименований = Неопределено)
	...
	Справочники.Saby_ВидыУпаковки.ЗагрузитьВидыУпаковкиСОнлайна(МассивНаименований, Результат);
