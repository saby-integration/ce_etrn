...
Функция ТаблицаДанныхДляЗагрузки()
	...
	РезультатФункции.Колонки.Добавить("Наименование",            Saby_ТНОбщегоНазначенияКлиентСервер.ОписаниеТипаСтрока(150));
	РезультатФункции.Колонки.Добавить("ТехническоеНаименование", Saby_ТНОбщегоНазначенияКлиентСервер.ОписаниеТипаСтрока(255));
	РезультатФункции.Колонки.Добавить("Код",                     Saby_ТНОбщегоНазначенияКлиентСервер.ОписаниеТипаСтрока(16));
