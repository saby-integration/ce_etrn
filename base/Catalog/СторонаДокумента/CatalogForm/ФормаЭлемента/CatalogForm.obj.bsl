...
Процедура СтранаРегистрацииПриИзменении(Элемент)
	...
	Если НРег(Объект.СтранаРегистрации) <> "россия" Тогда 
	    Объект.ЮрФизЛицо = ЗначениеМетаданныхКлиент("ESD_ЮрФизЛицо.ЮрЛицоНеРезидент");
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	ЭтоЮрЛицо  = Объект.ЮрФизЛицо = ЗначениеМетаданныхКлиент("ESD_ЮрФизЛицо.ЮрЛицо"); 
	
	ИП      = ЗначениеМетаданныхКлиент("ESD_ЮрФизЛицо.ИндивидуальныйПредприниматель");
	ФизЛицо = ЗначениеМетаданныхКлиент("ESD_ЮрФизЛицо.ФизЛицо");
