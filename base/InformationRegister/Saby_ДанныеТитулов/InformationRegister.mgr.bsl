...
//
Функция ДанныеДляЛенты(СсылкаНаДокумент, ИмяМетаданных, ТекущиеЭтапыДокумента) Экспорт
	
	РезультатФункции = Новый Массив;
	
	МенеджерТитулов = Документы[ИмяМетаданных].МенеджерТитулов();
	МенеджерВременныхТаблиц = Новый МенеджерВременныхТаблиц;
	МенеджерТитулов.СформироватьТаблицуДополнения(МенеджерВременныхТаблиц, ТекущиеЭтапыДокумента, СсылкаНаДокумент);
	
	Документы[ИмяМетаданных].ДобавитьДополнительныеДанныеВЛенту(МенеджерВременныхТаблиц, СсылкаНаДокумент);
	...
	Пока ВыборкаДанных.Следующий() Цикл
		...
		Если ТипЗнч(СтруктураДанных.ИдентификаторТитула) = Тип("ДокументСсылка.Saby_ПутевойЛист") Тогда
...
Процедура ЗаполнитьОписание(СтруктураДанных)
	...
	Если СтруктураДанных.ТипТитула = Перечисления.Saby_ТипТитулаЭтрН.УведомлениеОУточнении
		Или СтруктураДанных.ТипТитула = Перечисления.Saby_ТипТитулаЭтрН.ПриемкаГруза
		Или СтруктураДанных.ТипТитула = Перечисления.Saby_ТипТитулаЭтрН.ВыдачаГруза Тогда
