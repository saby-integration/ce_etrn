...
Функция ВложенияДляЗагрузки(ОбъектДок, Титул, Вложения, ДопПараметры) Экспорт
	...
	Для Каждого СтруктураВложения Из Вложения Цикл
		...
		Идентификатор = МодульКода("ESD_ТНЗагрузкаСервер").ИдентификаторВложения(СтруктураВложения, Титул);
		...
		СтрокаВложения.Дата          = МодульКода("ESD_ТНЗагрузкаСервер").ДатаВложения(СтруктураВложения, Титул);
...
Функция ДанныеДляЛенты(ОбъектДок, ИмяМетаданных, ТекущиеЭтапыДокумента) Экспорт
	...
	|		ПО ESD_ДанныеТитулов.ТипТитула = ТаблицаДополнения.ТипТитула
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
