...
Функция ТекущиеЭтапыДокумента(Форма) Экспорт
	...
	Если ЗначениеЗаполнено(Форма.АктивныйЭтапСтрокой) Тогда
		ТекущийТитул = Перечисления.Saby_ТипТитулаЭтрН.ЗначениеПоПредставлению(Форма.АктивныйЭтапСтрокой);
	Иначе
...
Процедура ЗагрузкаТитулПогрузка(ОбъектДок, Вложения, Титул, ДопПараметры)
	...
	ЗаполнитьДанныеДокументовЭПД(ОбъектДок, СтруктураДок["СопроводительныеДокументы"]);
	...
	Saby_ТНЗагрузкаСервер.ЗаполнитьДанныеПоГрузам(ОбъектДок, СтруктураДок["Груз"], ДопПараметры.ЗагрузкаСОнлайна);
...
Процедура ЗаполнитьУсловияПеревозки(ОбъектДок, УсловияПеревозки)
	...
	Если ЗначениеЗаполнено(Переадресовка) Тогда 
		...
		Если ЗначениеЗаполнено(Подтверждение) Тогда 
			...
			ПодтверждениеСсылка = Saby_ТНЗагрузкаСервер.ЗагрузитьОдиночныйДокументЭПД(Подтверждение, Тип);
...
Процедура ЗаполнитьСоставителя(СоставительСОнлайна, ОбъектДок)
	...
	СоставительСтрокой = СоставительСОнлайна["НазваниеПолное"];
	
	СоставительСсылка = Справочники.Организации.НайтиПоНаименованию(СоставительСтрокой, Истина);
	ОбъектДок.Составитель = ?(Не СоставительСсылка.Пустая(), СоставительСсылка, СоставительСтрокой);
...
Процедура ЗаполнитьДанныеДокументовЭПД(ОбъектДок, ДанныеДокументов)
