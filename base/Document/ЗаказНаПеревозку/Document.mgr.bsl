...
Функция ПроверятьДанныеЮрЛица(СтрокаТЧ, ИмяТЧ, Реквизит, ДанныеДокумента)
	...
	ПроверятьУполномоченныхПеревозчика = СтрокаТЧ.Роль = ЗначениеМетаданных("ESD_РолиКонтрагентов.УполномоченноеЛицоПеревозчика")
		И ДанныеДокумента.ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЗнП.Утверждение");
		
	ПроверятьУполномоченныхЗаказчика = СтрокаТЧ.Роль = ЗначениеМетаданных("ESD_РолиКонтрагентов.УполномоченноеЛицо")
		И ДанныеДокумента.ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЗнП.Оформление");
	
	ПроверятьАдрес = Реквизит.РеквизитОбъекта = "Адрес" И ЗначениеЗаполнено(Реквизит.ЭлементФормы);
	ПроверятьИНН = Реквизит.РеквизитОбъекта = "ИНН";
	
	Возврат (ПроверятьУполномоченныхПеревозчика Или ПроверятьУполномоченныхЗаказчика)
		И (ПроверятьАдрес Или ПроверятьИНН Или ПроверятьДанныеИП(СтрокаТЧ, Реквизит));
