...
Процедура ГрузыПриАктивизацииСтроки(Элемент)
	...
	МодульКодаКлиент("ESD_ТНОбщегоНазначенияКлиентСервер").УстановитьОтборПоСвязаннымТаблицам(ЭтаФорма, СтруктураСвязанныхТаблиц);
...
Процедура ПриЧтенииСозданииПослеЗаписиНаСервере() Экспорт
	...
	СтруктураСвязанныхТаблиц = СвязанныеСГрузомТаблицы();
	МодульКода("ESD_ТНОбщегоНазначенияКлиентСервер").УстановитьОтборПоСвязаннымТаблицам(ЭтаФорма, СтруктураСвязанныхТаблиц);
...
Процедура ОбновитьВидимостьПоЭтапуИУчастнику()
	...
	Элементы.ГруппаКомандыДокументаОснования.Видимость = Не (Признаки.Этапы.ДОЗавершен Или Этаформа.ТолькоПросмотр);
	...
	Если Элементы.Найти("ФормаСоздать_ТранспортнаяНакладная") <> Неопределено Тогда
		Элементы.ФормаСоздать_ТранспортнаяНакладная.Доступность = Признаки.Этапы.ДОЗавершен
	...
	МодульТНОбщегоНазначенияКлиентСервер.ИзменитьСвойствоЭлементовФормы(
		ЭтаФорма, "ТолькоПросмотр", Не Признаки.Этапы.ОформлениеДоступно Или ЭтаФорма.ТолькоПросмотр, УстановитьТолькоПросмотр);
	...
	МодульТНОбщегоНазначенияКлиентСервер.ИзменитьСвойствоЭлементовФормы(
		ЭтаФорма, "ТолькоПросмотр", Не Признаки.Этапы.УтверждениеДоступно Или Признаки.Этапы.ДОЗавершен Или ЭтаФорма.ТолькоПросмотр, ВидимостьИПросмотр);
		
	УстановитьДоступность = Новый Массив;
	УстановитьДоступность.Добавить("ПрицепыДобавить");
	УстановитьДоступность.Добавить("ВодителиДобавить");
	МодульТНОбщегоНазначенияКлиентСервер.ИзменитьСвойствоЭлементовФормы(
		ЭтаФорма, "Доступность", Признаки.Этапы.УтверждениеДоступно, УстановитьДоступность);
...
Функция ПризнакиДокумента()
	...
	ДОЗавершен = МодульКода("ESD_ТНОбщегоНазначенияКлиентСервер").ДокументооборотЗавершен(ЭтаФорма);
