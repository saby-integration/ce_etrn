...
Функция Груз(ДанныеДокумента)
	...
	Для Каждого СтрокаГруза Из ДанныеДокумента.Грузы Цикл
		...
		ОбразецПунктаПогрузкиВыгрузки = ШаблонПунктПогрузкиВыгрузки();
		ЗаполнитьЗначенияСвойств(ОбразецПунктаПогрузкиВыгрузки, СтрокаГруза);
		СтруктураГруза.ПунктыПогрузкиВыгрузки.Добавить(ОбразецПунктаПогрузкиВыгрузки);
...
Функция ШаблонГруза()
	...
	РезультатФункции.Вставить("ПунктыПогрузкиВыгрузки",        Новый Массив);
