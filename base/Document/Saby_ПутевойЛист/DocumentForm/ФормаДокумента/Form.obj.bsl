...
Процедура Печать(Команда)
	...
	ФормаОбъект = Saby_ТНОбщегоНазначенияКлиентСервер.ФормаОбъект(ЭтаФорма);
	...
	ЗаголовокПечатнойФормы = Saby_ТНОбщегоНазначенияКлиентСервер.СтрШаблонЭПД(
		ЗаголовокПечатнойФормы, ФормаОбъект.Номер, Формат(ФормаОбъект.Дата, "ДФ=dd.MM.yyyy"));
	
	Saby_ТНОбщегоНазначенияКлиент.ПечатьДокумента(ЭтаФорма, Команда.Имя, ЗаголовокПечатнойФормы);
...
Функция ЗаполнениеНаОснованииINI() Экспорт
	...
	Результат = Saby_ТНОбщегоНазначенияСервер.ЗаполнитьНаОснованииINI(Объект, ДокументОснование, "Saby_ПутевойЛист");
