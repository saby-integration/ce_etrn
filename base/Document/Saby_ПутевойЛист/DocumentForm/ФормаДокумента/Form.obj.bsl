...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ПараметрыЗаписи.Вставить("СсылкаДляОбновленияЛенты", ЭтаФорма.ДокументОснование);
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("ОбновитьЛенту", , ПараметрыЗаписи.СсылкаДляОбновленияЛенты);
...
Процедура ТранспортноеСредствоСтрокойНажатие(Элемент, СтандартнаяОбработка)
	...
	Saby_ТНОбщегоНазначенияКлиент.ТранспортноеСредствоСтрокойНажатие(
		...
		Элементы.СтраницаОсновное.ТолькоПросмотр);
...
Функция ПризнакиДокумента()
	...
	РезультатФункции.Этапы.Вставить(
		"ВыпускДоступен",
		Saby_ТНОбщегоНазначенияСервер.ТипТитулаДоступенУчастнику(
			Объект.ТекущиеЭтапы,
			ТипыТитулов.Выпуск,
			ДОЗавершен));
	
	РезультатФункции.Этапы.Вставить(
		"ПредрейсовыйМедосмотрДоступен",
		Saby_ТНОбщегоНазначенияСервер.ТипТитулаДоступенУчастнику(
			Объект.ТекущиеЭтапы,
	...
	РезультатФункции.Этапы.Вставить(
		"ПослерейсовыйМедосмотрДоступен",
		Saby_ТНОбщегоНазначенияСервер.ТипТитулаДоступенУчастнику(
			Объект.ТекущиеЭтапы,
...
Процедура УдалитьСтрокуПоРоли(Знач ИмяТаблицы, Знач РольСтрокой)
	...
	Saby_ТНОбщегоНазначенияКлиентСервер.УдалитьСтрокиПоРоли(Объект[ИмяТаблицы], РольСтрокой);
