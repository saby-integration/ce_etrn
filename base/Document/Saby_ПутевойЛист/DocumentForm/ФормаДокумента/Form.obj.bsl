...
Процедура ОрганизацияСтрокойНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыРеквизитаФормы.ТолькоПросмотр = Элементы.ОрганизацияСтрокой.ТолькоПросмотр;
...
Процедура ОбновитьВидимостьПоЭтапуИУчастнику()
	...
	ДоступнаЗаменаВодителя = Признаки.Этапы.ПринимающийДоступен И Не Признаки.Этапы.ДОЗавершен;
...
Функция ПризнакиДокумента()
	...
	РезультатФункции.Вставить(
		"ЭтоЗаменаВодителя",
		Объект.ПризнакНачалаРейса = Перечисления.Saby_ПризнакНачалаРейса.ПриемСдачаПослеСмены
