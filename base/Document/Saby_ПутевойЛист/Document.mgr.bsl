...
Процедура ДополнитьПроверяемыеРеквизитыЭтапаВыпуск(ДанныеДокумента, ПроверяемыеРеквизиты)
	...
	ВодительСтрокой = "ВодительСтрокой";
		
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители", ВодительСтрокой, "Не заполнен водитель"));
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители.Фамилия", ВодительСтрокой, "Не заполнена фамилия водителя"));
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители.Имя", ВодительСтрокой, "Не заполнено имя водителя"));
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители.Серия", ВодительСтрокой, "Не заполнена серия водительского удостоверения"));
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители.Номер", ВодительСтрокой, "Не заполнена номер водительского удостоверения"));
	ПроверяемыеРеквизиты.Добавить(
		ФЛК("Водители.ДатаВыдачи", ВодительСтрокой, "Не заполнена дата выдачи водительского удостоверения"));
...
Процедура ДополнитьПроверяемыеРеквизитыЭтапаПредрейсовыйМедосмотр(ПроверяемыеРеквизиты)
	...
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители", ВодительСтрокой, "Не заполнен водитель"));
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители.Фамилия", ВодительСтрокой, "Не заполнена фамилия водителя"));
	ПроверяемыеРеквизиты.Добавить(ФЛК("Водители.Имя", ВодительСтрокой, "Не заполнена имя водителя"));
