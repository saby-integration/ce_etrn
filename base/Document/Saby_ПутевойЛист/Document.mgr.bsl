...
Функция ТитулВыпуск(ДанныеДокумента)
	...
	СтруктураТитула.Вставить(
		...
		Saby_ТНВыгрузкаСервер.ПодстановкиТранспортногоСредства(ДанныеДокумента.ТранспортныеСредства, , Истина));
		
	СтруктураТитула.ТранспортноеСредство.Вставить(
		"Прицеп", 
		Saby_ТНВыгрузкаСервер.ПодстановкиПрицепов(ДанныеДокумента.ТранспортныеСредства, Истина));
...
Функция ТитулПредрейсовыйТехосмотр(ДанныеДокумента)
	...
	СтруктураТитула.ТранспортноеСредство.Вставить(
		"Прицеп", Saby_ТНВыгрузкаСервер.ПодстановкиПрицепов(ДанныеДокумента.ТранспортныеСредства, Истина));
