...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Saby_ТНОбщегоНазначенияКлиентСервер.УдалитьСтрокиПоРоли(ЭтотОбъект.ОтветственныеЛица, "ОдометрВыезд");
	Saby_ТНОбщегоНазначенияКлиентСервер.УдалитьСтрокиПоРоли(ЭтотОбъект.ОтветственныеЛица, "ОдометрЗаезд");
	
	Если ДоРейса_МедосмотрСторонняяОрганизация Тогда
		Saby_ТНОбщегоНазначенияКлиентСервер.УдалитьСтрокиПоРоли(ЭтотОбъект.ОтветственныеЛица, "МедосмотрВыезд");		
	КонецЕсли;	
		
	Если ПослеРейса_МедосмотрСторонняяОрганизация Тогда
		Saby_ТНОбщегоНазначенияКлиентСервер.УдалитьСтрокиПоРоли(ЭтотОбъект.ОтветственныеЛица, "МедосмотрЗаезд");
	КонецЕсли;	
