...
&НаКлиенте
Процедура ВыгрузитьДанные(ЭтапДляПерехода = Неопределено)
	
	ДополнительныеПараметры = Новый Структура;
	
	Если ЭтапДляПерехода <> Неопределено Тогда
		ДополнительныеПараметры.Вставить("ЭтапДляПерехода", ЭтапДляПерехода);
	КонецЕсли;
...
Процедура СтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	Если Элементы.Страницы.ТекущаяСтраница.Заголовок = "События" Тогда	
