...
Функция ПризнакиДокумента()
	...
	ВыпускДоступен = МодульКода("ESD_ТНОбщегоНазначенияСервер").ТипТитулаДоступенУчастнику(
		ЭтаФорма,
		Объект.ТекущиеЭтапы,
		ТипыТитулов["Выпуск"],
		ДОЗавершен);
	...
	ПредрейсовыйМедосмотрДоступен = МодульКода("ESD_ТНОбщегоНазначенияСервер").ТипТитулаДоступенУчастнику(
		ЭтаФорма,
		Объект.ТекущиеЭтапы,
	...
	ПредрейсовыйТехосмотрДоступен = МодульКода("ESD_ТНОбщегоНазначенияСервер").ТипТитулаДоступенУчастнику(
		ЭтаФорма,
		Объект.ТекущиеЭтапы,
	...
	ВыпускающийДоступен = МодульКода("ESD_ТНОбщегоНазначенияСервер").ТипТитулаДоступенУчастнику(
		ЭтаФорма,
		Объект.ТекущиеЭтапы,
	...
	ПринимающийДоступен = МодульКода("ESD_ТНОбщегоНазначенияСервер").ТипТитулаДоступенУчастнику(
		ЭтаФорма,
		Объект.ТекущиеЭтапы,
	...
	ПослерейсовыйМедосмотрДоступен = МодульКода("ESD_ТНОбщегоНазначенияСервер").ТипТитулаДоступенУчастнику(
		ЭтаФорма,
		Объект.ТекущиеЭтапы,
...
Процедура ОбновитьДоступностьПолейЗаменыВодителя(Признаки = Неопределено)
	...
	ДоступнаЗаменаВодителя = Признаки.Этапы.ТекущийЭтапПринимающий
...
Функция ЗаполнениеНаОснованииINI() Экспорт
	...
	Результат = МодульКода("ESD_ТНОбщегоНазначенияСервер").ЗаполнитьНаОснованииINI(Объект, ДокументОснование, ПутевойЛист());
