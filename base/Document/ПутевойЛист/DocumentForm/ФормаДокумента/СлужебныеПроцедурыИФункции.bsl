...
#Область include_etrn_base_Document_ПутевойЛист_DocumentForm_ФормаДокумента_НастройкиФормы
#КонецОбласти // include_etrn_base_Document_ПутевойЛист_DocumentForm_ФормаДокумента_НастройкиФормы
