...
Процедура ЗаполнитьТитулИзмененияСтоимости(Идентификатор)
	...
	Если Выборка.Следующий() Тогда  
		...
		Если ДанныеФормы.Свойство("ДанныеЮрЛиц") Тогда
			ЗаполнитьЗначенияСвойств(ЭтаФорма, ДанныеФормы, , "ДанныеЮрЛиц,КонтактныеДанные,ДокументыЭПД");
		Иначе
...
Процедура ПутевыеЛистыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если Не Копирование Тогда
		ПараметрыКлючаСвязиСтрок = ПараметрыКлючаСвязиСтрок(Элемент.Имя, "Водители", Элемент.ТекущаяСтрока, НоваяСтрока);
		ДобавитьКлючСвязиСтроки(ЭтаФорма, ПараметрыКлючаСвязиСтрок);
	КонецЕсли;
