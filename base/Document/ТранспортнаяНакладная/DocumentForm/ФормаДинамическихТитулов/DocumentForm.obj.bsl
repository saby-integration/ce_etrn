...
Функция РасчетЭтапа(Знач Титул)
	...
	Этап.Вставить(ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ИзменениеСтоимости"),       "Изменить стоимость");
...
Процедура ЗаполнитьДанныеТитула_Стоимости()
	...
	Если ЭтаФорма.ЭтоСогласование Тогда
		...
		ЗаголовокФормы   = "Согласовать стоимость";
		
	Иначе
		
		ЗаголовокКоманды = "Изменить стоимость";
		ЗаголовокФормы   = "Изменить стоимость";
...
Процедура ОбновитьДанныеПоОшибкамНаСервере(Знач ДанныеДокументовЭПД, Знач Ошибки = Неопределено)
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ТипТитула",               ЭтаФорма.ТипТитула);
	...
	МодульКода("ESD_ТНОбщегоНазначенияСервер").ОбновитьОшибки(ЭтаФорма,
