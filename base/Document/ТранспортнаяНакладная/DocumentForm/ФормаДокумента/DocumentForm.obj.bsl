...
Процедура ПослеИзмененияОтправителя(Результат, ДополнительныеПараметры) Экспорт
	ПослеИзмененияОтправителяНаСервере();
КонецПроцедуры
...
Процедура ПослеИзмененияПолучателя(Результат, ДополнительныеПараметры) Экспорт
	ПослеИзмененияПолучателяНаСервере();
КонецПроцедуры
...
&НаСервере
Процедура ПослеИзмененияОтправителяНаСервере()
	Если ЭтаФорма.Грузоотправитель_ОсуществляетОтгрузку Тогда
		ЗаполнитьЮрЛицоКопированиемНаСервере("Отгрузчик", "Отправитель");
	КонецЕсли;
	
	ЗаполнитьДополнительныеДанныеЮрЛица("Отправитель");
КонецПроцедуры

&НаСервере
Процедура ПослеИзмененияПолучателяНаСервере()
	ОбработатьДанныеГрузоотправителяГрузополучателяНаСервере();	
	ЗаполнитьДополнительныеДанныеЮрЛица("Получатель");
КонецПроцедуры
...
&НаСервере
Процедура ОбновитьАдресаПогрузкиВыгрузкиНаСервере(РольСтрокой)
	ИсточникДанных = ИсточникДанных();
