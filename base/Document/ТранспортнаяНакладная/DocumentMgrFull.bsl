...
#Область include_etrn_base_Document_Общее
#КонецОбласти
...
Функция ДанныеПриемкаГруза(ОбъектДок, Вложения, Титул, ДопПараметры)
	...
	Для Каждого Вложение Из ВложенияДляЗагрузки Цикл
		...
		ИначеЕсли ВидОперации.Отменена Тогда
			ДляДокумента.Вставить(КлючПредставление, ПриемкаГруза_НеПолучен());	
		Иначе
...
// Возвращает представление выбора "Не получен" этапа/титула "Приемка груза"
//
// Возвращаемое значение:
//   Строка - представление выбора "Не получен"
//
Функция ПриемкаГруза_НеПолучен() Экспорт
	Возврат "Не получен";
КонецФункции
