...
Процедура ОбновитьВидимостьДоступностьЭлементовФормы(ТолькоПросмотр)
	...
	МассивЭлементов.Добавить("ЗаполнитьНаОсновании");
	
	Saby_ТНОбщегоНазначенияКлиентСервер.ИзменитьВидимостьДоступностьЭлементовФормы(
		ЭтаФорма, "Доступность", Не ТолькоПросмотр, МассивЭлементов);
	...
	Если ЭтаФорма.ТипДокументаИсточника = Тип("ДокументСсылка.Saby_ПутевойЛист") Тогда
		...
		МассивЭлементов.Добавить("ВИН");
		МассивЭлементов.Добавить("НомерСТС");
		МассивЭлементов.Добавить("Грузоподъемность");
		МассивЭлементов.Добавить("Вместимость");
		МассивЭлементов.Добавить("ТипВладения");
		МассивЭлементов.Добавить("ОснованияВладения");
						
	Иначе			
		МассивЭлементов.Добавить("Модель");
		МассивЭлементов.Добавить("ИнвентарныйНомер");
	КонецЕсли;
	
	Saby_ТНОбщегоНазначенияКлиентСервер.ИзменитьВидимостьДоступностьЭлементовФормы(
		ЭтаФорма, "Видимость", Ложь, МассивЭлементов);
