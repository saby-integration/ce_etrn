...
Процедура ОбновитьВидимостьДоступностьПоРолям(МассивПоказать, МассивСкрыть)
	...
	ЭтоПутевойЛист = (ЭтаФорма.ТипДокументаИсточника = Тип("ДокументСсылка.Saby_ПутевойЛист"));
	
	Если (ЭтоПутевойЛист
		И ЭтаФорма.Роль <> Перечисления.Saby_РолиКонтрагентов.Оформитель)
		Или ЭтаФорма.Роль = Перечисления.Saby_РолиКонтрагентов.СторонаДокумента Тогда
	...
	Если ЭтаФорма.Роль = Перечисления.Saby_РолиКонтрагентов.Оформитель
	...
	Если ЭтаФорма.Роль = Перечисления.Saby_РолиКонтрагентов.МедосмотрВыезд
		Или ЭтаФорма.Роль = Перечисления.Saby_РолиКонтрагентов.МедосмотрЗаезд Тогда
