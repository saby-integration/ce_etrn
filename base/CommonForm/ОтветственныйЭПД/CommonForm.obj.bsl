...
Функция ЗаполнитьДанныеОтветственногоЭПД_НаОснованииСправочникаРасширения(Знач ОтветственноеЛицо)
	...
	ЗапросДанных.Текст =
	"ВЫБРАТЬ
	|	ESD_ОтветственныеЛица.СерияВУ КАК Серия,
	|	ESD_ОтветственныеЛица.НомерВУ КАК Номер,
	|	ESD_ОтветственныеЛица.ДатаВыдачиВУ КАК ДатаВыдачи,
	|	*
	|ИЗ
	|	Справочник.ESD_ОтветственныеЛица КАК ESD_ОтветственныеЛица
	|ГДЕ
	|	ESD_ОтветственныеЛица.Ссылка = &Ссылка";
	
	ЗапросДанных.УстановитьПараметр("Ссылка", ОтветственноеЛицо);
	
	ВыборкаДанных = ЗапросДанных.Выполнить().Выбрать();
	Если ВыборкаДанных.Следующий() Тогда
		
		ЗаполнитьЗначенияСвойств(ДанныеОтветственногоЭПД, ВыборкаДанных, , "Телефоны");
		
		ДанныеОтветственногоЭПД.Роль = ЭтаФорма.Роль;
		ДанныеОтветственногоЭПД.Телефоны = Новый Массив;
		ВыборкаТелефонов = ВыборкаДанных.Телефоны.Выбрать();
		Пока ВыборкаТелефонов.Следующий() Цикл
			ДанныеОтветственногоЭПД.Телефоны.Добавить(ВыборкаТелефонов.Телефон);
		КонецЦикла; 
		
		// Лицензия
		ДанныеОтветственногоЭПД.Вставить("ЛицензияСерия",  ВыборкаДанных.ЛицензияСерия);
		ДанныеОтветственногоЭПД.Вставить("ЛицензияНомер",  ВыборкаДанных.ЛицензияНомер);
		ДанныеОтветственногоЭПД.Вставить("ЛицензияДатаС",  ВыборкаДанных.ЛицензияДатаС);
		ДанныеОтветственногоЭПД.Вставить("ЛицензияДатаПо", ВыборкаДанных.ЛицензияДатаПо);
