...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МодульКода("Saby_ТНОбщегоНазначенияСервер").ESD_ЗаполнитьРеквизитыФормы(ЭтаФорма, Параметры);
...
Процедура УстановитьНовыеДанные(Команда)
	...
	ОпасныйГруз.Вставить("ОпасныйГруз", ЭтаФорма.ОпасныйГрузНаименование);				
...
Функция ПроверкаЗаполнения()
	...
	ПроверяемыеРеквизиты.Добавить("ОпасныйГрузНаименование");
