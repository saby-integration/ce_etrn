...
//   Структура - параметры для открытия формы документа ЭПД.
//
...
Функция СформироватьДокументыЭПД(ТаблицаДокументовЭПД, ТаблицаЮрЛиц) Экспорт
	...
	Если ЭтаФорма.ЭтоВО И ТаблицаДокументовЭПД.Количество() Тогда
		...
		Для Каждого СтрокаДокументов Из ТаблицаДокументовЭПД Цикл
			...
			ДополнитьСтруктуруДокументаЭПДПолямиДляФЛККлиент(СтруктураДанных);
...
&НаКлиенте
Процедура ДополнитьСтруктуруДокументаЭПДПолямиДляФЛККлиент(СтруктураДокументаЭПД)
	...
	Если СтруктураДокументаЭПД.Тип = ЗначениеМетаданных("Saby_ТипыДокумента.КТранспортнойНакладной") Тогда
		
		СтруктураДокументаЭПД.РеквизитОбъекта = "ДокументЗамены";
		СтруктураДокументаЭПД.ЭлементФормы    = "ДокументЗамены";
		
	ИначеЕсли СтруктураДокументаЭПД.Тип = ЗначениеМетаданных("Saby_ТипыДокумента.ПередачиЦенностей")
		И ЭтаФорма.ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС") Тогда
		
		СтруктураДокументаЭПД.РеквизитОбъекта = "ОснованиеПередачиГрузаТС";
		СтруктураДокументаЭПД.ЭлементФормы    = "ОснованиеПередачиГрузаТС";
		
	ИначеЕсли СтруктураДокументаЭПД.Тип = ЗначениеМетаданных("Saby_ТипыДокумента.ОснованиеОплатыПеревозки") Тогда
		
		СтруктураДокументаЭПД.РеквизитОбъекта = "ОснованиеОплаты";
		СтруктураДокументаЭПД.ЭлементФормы    = "ОснованиеОплаты";
		
	ИначеЕсли СтруктураДокументаЭПД.Тип = ЗначениеМетаданных("Saby_ТипыДокумента.ПередачиЦенностей")
		И Не ЭтаФорма.ТипТитула = ЗначениеМетаданных("ESD_ТипТитулаЭтрН.ЗаменаВодителяТС") Тогда
		
		СтруктураДокументаЭПД.РеквизитОбъекта = "ПереадресовкаНаОсновании";
		СтруктураДокументаЭПД.ЭлементФормы    = "ПереадресовкаНаОсновании";
		
	ИначеЕсли СтруктураДокументаЭПД.Тип = ЗначениеМетаданных("Saby_ТипыДокумента.ПутевойЛист") Тогда
		
		СтруктураДокументаЭПД.РеквизитОбъекта = "ПутевыеЛисты.Документ";
		СтруктураДокументаЭПД.ЭлементФормы    = "ПутевыеЛистыДокумент";
		СтруктураДокументаЭПД.ИмяТаблицы      = "ПутевыеЛисты";
		СтруктураДокументаЭПД.НомерСтроки     = НомерСтрокиДокументаКлиент(ЭтаФорма.ПутевыеЛисты, СтруктураДокументаЭПД.КлючСтроки);
		
	ИначеЕсли СтруктураДокументаЭПД.Тип = ЗначениеМетаданных("Saby_ТипыДокумента.АктКоммерческий") Тогда
		...
		СтруктураДокументаЭПД.НомерСтроки     = НомерСтрокиДокументаКлиент(ЭтаФорма.Акты, СтруктураДокументаЭПД.КлючСтроки);
...
&НаКлиенте
Функция НомерСтрокиДокументаКлиент(ТаблицаДокументов, КлючСтроки, ИмяКлюча = "КлючСтроки_ДокументыЭПД")
	
	РезультатФункции = 0;
	
	Отбор = Новый Структура;
	Отбор.Вставить(ИмяКлюча, КлючСтроки);
