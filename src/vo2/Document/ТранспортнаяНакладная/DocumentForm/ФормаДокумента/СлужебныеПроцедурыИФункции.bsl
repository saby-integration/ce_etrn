...
Процедура ПрочитатьИзСтруктуры(СтруктураДанных) Экспорт
	...
	// Это черновик
	Если СтруктураДанных.Состояние = Неопределено Тогда
...
#КонецОбласти // include_etrn_src_vo2_CommonModule_ТНОбщегоНазначенияСервер_ЗаполнениеНаОснованииИНИ //&НаКлиенте
...
#КонецОбласти // include_etrn_src_vo2_CommonModule_ДокументыЭПД //&НаКлиенте
